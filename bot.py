...
index 4c080b4053ab693ac922b01a2e4154125076798e..8fd9430e0ae9f55bedb3f74729366f291e2b0c0c 100644
--- a/bot.py
+++ b/bot.py
@@ -1,465 +1,720 @@
 import os
...
@@ -478,47 +733,45 @@ async def group_messages(message: Message, bot: Bot):
